...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    # complete this function below here
    if question_type =='sum':
        right_answer = die_1_value + die_2_value
    else:
        right_answer = abs(die_1_value - die_2_value)
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == 'sum':
        right_answer = die_1_value + die_2_value
        print(f"No! The sum of {die_1_value} and {die_2_value} is {right_answer}!")
    else:
        right_answer = abs(die_1_value - die_2_value)
        print(f"No! The difference between {die_1_value} and {die_2_value} is {right_answer}!")
